...
struct KernelConfig {
  ...
  // Tiling configuration (for MLIR and other optimization strategies)
  std::vector<int> tile_sizes;  // [tile_m, tile_n, tile_k, ...]
  
  // Vectorization configuration
  int vector_width = 4;  // Number of elements per vector
