...
/**
 * @brief NKI (Neuron Kernel Interface) backend for AWS Inferentia/Trainium
 */
class NKIBackend : public BackendInterface {
public:
  NKIBackend();
  virtual ~NKIBackend() = default;
