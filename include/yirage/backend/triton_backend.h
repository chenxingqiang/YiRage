...
/**
 * @brief Triton compiler backend implementation
 */
class TritonBackend : public BackendInterface {
public:
  TritonBackend();
  ...
  // Memory Management (delegates to CUDA)
...
private:
  bool check_triton_availability();
