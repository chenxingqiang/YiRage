...
#include "search/symbolic_graph/dim_var_assignments.h"
#include "search/symbolic_graph/tensor_dim_constraints.h"
...
class Sigmoid : public AbstractExpr {
public:
  Sigmoid(std::shared_ptr<AbstractExpr const> a);
  std::string to_string() const override;
  std::string to_egg() const override;
  std::shared_ptr<AbstractExpr const> a;
};
...
class Log : public AbstractExpr {
public:
  Log(std::shared_ptr<AbstractExpr const> a);
  std::string to_string() const override;
  std::string to_egg() const override;
  std::shared_ptr<AbstractExpr const> a;
};
...
public:
  Sub(std::shared_ptr<AbstractExpr const> lhs,
      std::shared_ptr<AbstractExpr const> rhs);
  std::string to_string() const override;
  std::string to_egg() const override;
  std::shared_ptr<AbstractExpr const> lhs, rhs;
...
class Concat : public AbstractExpr {
public:
  Concat(int concat_dim,
...
class Split : public AbstractExpr {
public:
  Split(int split_dim,
        int split_size,
        int output_part,
