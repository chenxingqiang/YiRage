...
#include "search/symbolic_graph/symbolic_tensor_dim.h"
...
template <>
struct hash<yirage::search::TensorDimConstraint> {
  size_t
      operator()(yirage::search::TensorDimConstraint const &constraint) const;
};
