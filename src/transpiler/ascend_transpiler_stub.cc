...
// Code generation path options
enum class CodeGenPath {
    TRITON,    // Use Triton + BiSheng (RECOMMENDED)
    ASCEND_C,  // Use Ascend C directly
    TBE        // Use TBE (legacy)
};
...
struct AscendTranspilerConfig {
    ...
    CodeGenPath codegen_path = CodeGenPath::TRITON;  // Default to Triton
};
