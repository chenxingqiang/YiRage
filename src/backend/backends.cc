...
// NOTE: Static initialization removed to avoid deadlock with Z3
// Backends are now initialized lazily on first use or explicitly via
// initialize_backends() from Python
