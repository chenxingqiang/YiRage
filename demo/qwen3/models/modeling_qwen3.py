...
class Qwen3Attention(nn.Module):
    ...
    def forward(
        ...
        query_states = self.q_norm(
            query_states.view(bsz, q_len, self.num_heads // self.world_size, self.head_dim)
        )
        key_states = self.k_norm(
            key_states.view(bsz, q_len, self.num_key_value_heads // self.world_size, self.head_dim)
        )
