    ...
    *, quick: bool = True, yirage_core: bool = False
    ...
    stages: List[CertStage] = [
        ...
        CertStage(
            "s33_contract",
            "pytest",
            "tests/python/test_runtime_fusion_s33_multistep_generation.py",
        ),
        CertStage(
            "s34_contract",
            "pytest",
        ...
        CertStage(
            "s35_contract",
            "pytest",
            "tests/python/test_runtime_fusion_s35_engine_native_multistep.py",
        ),
        CertStage(
            "s36_contract",
            "pytest",
        ...
        CertStage(
            "s41_contract",
            "pytest",
            "tests/python/test_runtime_fusion_s41_dashboard_artifact_validate.py",
        ),
        CertStage(
            "s42_contract",
            "pytest",
