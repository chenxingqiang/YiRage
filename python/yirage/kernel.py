    ...
    def superoptimize(
        ...
        if backend == "mps":
            ...
            if griddims is None and blockdims is None and franges is None:
                from .mps_config import get_mps_search_config
            ...
            if griddims is None and blockdims is None and franges is None:
                from .mps_config import get_cpu_search_config
                ...
                print(f"✓ CPU backend: Using cache-friendly optimized search")
                print(f"  - Configs: {len(griddims)} grids, {len(blockdims)} blocks")
                print(f"  - Franges: {franges}")
            else:
            ...
            if griddims is None and blockdims is None and franges is None:
                from .maca_config import get_maca_search_config
        ...
        if backend == "cuda":
            ...
            # CPU backend: profile and select best graph
