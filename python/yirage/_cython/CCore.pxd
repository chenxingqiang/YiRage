...
cdef extern from "yirage/vector_types.h":
...
cdef extern from "yirage/type.h" namespace "yirage::type":
    # This must be consistent with yirage/type.h
    cdef enum DataType:
        DT_FLOAT4 = 920,
        DT_INT4 = 925,
        DT_UINT4 = 926,
...
cdef extern from "yirage/layout.h" namespace "yirage::layout":
    # This must be consistent with yirage/layout.h
...
cdef extern from "yirage/kernel/device_tensor.h" namespace "yirage::kernel":
...
cdef extern from "yirage/kernel/runtime.h" namespace "yirage::runtime":
    ctypedef struct TaskGraphResult:
        string cuda_code
        string json_file

cdef extern from "yirage/kernel/graph.h" namespace "yirage::kernel":
...
cdef extern from "yirage/threadblock/graph.h" namespace "yirage::threadblock":
...
cdef extern from "yirage/search/search_c.h" namespace "yirage::search_c":
...
cdef extern from "yirage/transpiler/transpile.h" namespace "yirage::transpiler":
...
cdef extern from "yirage/nki_transpiler/transpile.h" namespace "yirage::nki_transpiler":
...
cdef extern from "yirage/triton_transpiler/transpile.h" namespace "yirage::triton_transpiler":
...
cdef extern from "yirage/backend/backends.h" namespace "yirage::backend":
