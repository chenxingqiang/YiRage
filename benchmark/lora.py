...
if __name__ == "__main__":
    ...
    input_tensors = [
        torch.randn(16, 256, dtype=torch.float16, device=device),
        torch.randn(256, 4096, dtype=torch.float16, device=device),
        torch.randn(256, 16, dtype=torch.float16, device=device),
        torch.randn(16, 4096, dtype=torch.float16, device=device)
    ]
