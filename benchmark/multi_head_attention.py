...
if __name__ == "__main__":
    ...
    input_tensors = [
        torch.randn(32 * batch_size, 16, 64, dtype=torch.float16, device=device),
        torch.randn(32 * batch_size, 64, 4096, dtype=torch.float16, device=device),
        torch.randn(32 * batch_size, 4096, 64, dtype=torch.float16, device=device)
    ]
