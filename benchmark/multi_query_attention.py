...
if __name__ == "__main__":
    ...
    input_tensors = [
        torch.randn(batch_size, 1024, 64, dtype=torch.float16, device=device),
        torch.randn(batch_size, 64, 4096, dtype=torch.float16, device=device),
        torch.randn(batch_size, 4096, 64, dtype=torch.float16, device=device)
    ]
