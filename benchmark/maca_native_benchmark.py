...
def run_benchmarks(quick=False):
    ...
    for M, N, K, name in matmul_configs:
        ...
        print(
            f"  {name:<12} {M}×{N}×{K:<12} {cpu_time*1000:>10.3f}  {maca_time*1000:>12.3f}  {speedup:>8.1f}x"
        )
    ...
    for batch, hidden, name in rmsnorm_configs:
        ...
        print(
            f"  {name:<12} ({batch}, {hidden})<8 {cpu_time*1000:>10.3f}  {maca_time*1000:>12.6f}  {speedup:>8.0f}x"
        )
