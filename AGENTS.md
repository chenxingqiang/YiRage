...
| **Combined nightly bundle validate** | archive + dashboard meta 联合 validate（G7 归档闭合） | `validate_serving_combined_nightly_bundle` | `scripts/validate_serving_combined_nightly_bundle.py`；`test_runtime_fusion_s42_*` | **partial（S42）** |
