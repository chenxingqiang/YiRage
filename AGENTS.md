...
| **Unified serving dashboard** | combined archive → JSON + markdown + HTML 摘要 | `build_serving_dashboard_from_combined_archive` | `scripts/render_serving_dashboard.py`；`test_runtime_fusion_s36_*` / `s39_*` | **partial（S36/S39）** |
