...
| **Combined nightly archive** | decode + G1 + multistep 联合 JSON（G7 链 A/B/C/D 归档） | `run_serving_combined_nightly_archive` | `scripts/serving_combined_nightly_archive.py`；`test_runtime_fusion_s34_*` | **partial（S34）** |
