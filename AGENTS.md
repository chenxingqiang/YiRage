...
| **vLLM paged multistep** | PagedAttention 多步 decode hidden + greedy token parity（G7 链 C paged） | `run_vllm_paged_multistep_bench` | `benchmark/serving_vllm_paged_multistep_bench.py`；`test_runtime_fusion_s37_*` | **partial（S37）** |
