...
| **Combined nightly archive** | decode + G1 + multistep + engine multistep 联合 JSON | `run_serving_combined_nightly_archive` | `scripts/serving_combined_nightly_archive.py`；`test_runtime_fusion_s34_*` | **partial（S34/S35）** |
