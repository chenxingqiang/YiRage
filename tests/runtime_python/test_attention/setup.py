...
include_dir = os.path.join(this_dir, '../../../include/persistent_kernel/tasks/ampere')
include_dir_2 = os.path.join(this_dir, '../../../include/persistent_kernel/tasks/common')
include_dir_3 = os.path.join(this_dir, '../../../include/persistent_kernel/')
