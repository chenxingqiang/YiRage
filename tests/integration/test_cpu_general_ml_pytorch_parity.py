...
@pytest.mark.parametrize(
    ...
    [
        ...
        "kn_softmax_3d_batch2",
        "kn_layer_norm",
        "kn_layer_norm_batch1",
        "kn_layer_norm_batch2",
        "kn_rms_norm_3d",
        "kn_rms_norm_3d_batch1",
        "kn_rms_norm_3d_batch2",
        "kn_rms_norm",
        "kn_rms_norm_batch1",
        "kn_rms_norm_batch2",
        "kn_unfused_rms_matmul",
        "kn_unfused_rms_matmul_batch1",
        "kn_unfused_rms_matmul_batch2",
        "kn_unfused_rms_matmul_batched",
        "kn_unfused_rms_matmul_batched_batch1",
        "kn_unfused_rms_matmul_batched_batch2",
        "kn_layer_norm_3d",
        "kn_layer_norm_3d_batch1",
        "kn_layer_norm_3d_batch2",
        "gemm_softmax",
        "gemm_softmax_batch1",
        "gemm_softmax_batch2",
        "gemm_softmax_scaled",
        "gemm_softmax_scaled_batch1",
        "gemm_softmax_scaled_batch2",
        "gemm_softmax_scaled_batched",
        "gemm_softmax_scaled_batched_batch1",
        "gemm_softmax_scaled_batched_batch2",
        "gemm_softmax_3d",
        "gemm_softmax_3d_batch1",
        "gemm_softmax_3d_batch2",
        "gemm_softmax_scaled_3d",
        "gemm_softmax_scaled_3d_batch1",
        "gemm_softmax_scaled_3d_batch2",
        "gemm_layernorm",
        "gemm_layernorm_batch1",
        "gemm_layernorm_batch2",
        "gemm_layernorm_gelu",
        "gemm_layernorm_gelu_batch1",
        "gemm_layernorm_gelu_batch2",
        "gemm_layernorm_relu",
        "gemm_layernorm_relu_batch1",
        "gemm_layernorm_relu_batch2",
        "gemm_layernorm_silu",
        "gemm_layernorm_silu_batch1",
        "gemm_layernorm_silu_batch2",
        "gemm_layernorm_3d",
        "gemm_layernorm_3d_batch1",
        "gemm_layernorm_3d_batch2",
        "gemm_layernorm_3d_gelu",
        "gemm_layernorm_3d_gelu_batch1",
        "gemm_layernorm_3d_gelu_batch2",
        "gemm_layernorm_3d_relu",
        "gemm_layernorm_3d_relu_batch1",
        "gemm_layernorm_3d_relu_batch2",
        "gemm_layernorm_3d_silu",
        "gemm_layernorm_3d_silu_batch1",
        "gemm_layernorm_3d_silu_batch2",
        "gemm_gelu",
        "gemm_gelu_batch1",
        "gemm_gelu_batch2",
        "gemm_gelu_3d",
        ...
        "gemm_bias_3d_relu_batch2",
        "gemm_bias_3d_gelu_batch1",
        "gemm_bias_3d_gelu_batch2",
        "gemm_bias_3d_silu_batch1",
        "gemm_bias_3d_silu_batch2",
        "gemm_bias_3d_gelu",
        "gemm_bias_3d_silu",
        "gated_mlp",
        "gated_mlp_gelu",
        ...
        "conv2d_bias_batch2",
        "conv2d_bias_relu",
        "conv2d_bias_relu_batch1",
        "conv2d_bias_relu_batch2",
        "conv2d_bias_gelu",
        "conv2d_bias_gelu_batch1",
        "conv2d_bias_gelu_batch2",
        "conv2d_bias_silu",
        "conv2d_bias_silu_batch1",
        "conv2d_bias_silu_batch2",
        "conv2d_groups",
        "conv2d_groups_batch1",
        "conv2d_groups_batch2",
        "conv2d_groups_relu",
        "conv2d_groups_gelu",
        "conv2d_groups_silu",
        "conv2d_groups_relu_batch1",
        "conv2d_groups_relu_batch2",
        "conv2d_groups_gelu_batch1",
        "conv2d_groups_gelu_batch2",
        "conv2d_groups_silu_batch1",
        "conv2d_groups_silu_batch2",
        "conv2d_bias_groups",
        "conv2d_bias_groups_batch1",
        "conv2d_bias_groups_batch2",
        "conv2d_depthwise",
        "conv2d_depthwise_batch1",
        "conv2d_depthwise_batch2",
        "conv2d_depthwise_relu",
        "conv2d_depthwise_gelu",
        "conv2d_depthwise_silu",
        "conv2d_depthwise_relu_batch1",
        "conv2d_depthwise_gelu_batch1",
        "conv2d_depthwise_silu_batch1",
        "conv2d_depthwise_relu_batch2",
        "conv2d_depthwise_gelu_batch2",
        "conv2d_depthwise_silu_batch2",
        "conv2d_depthwise_bias",
        "conv2d_depthwise_bias_batch1",
        "conv2d_depthwise_bias_batch2",
        "conv2d_depthwise_bias_relu",
        "conv2d_depthwise_bias_relu_batch1",
        "conv2d_depthwise_bias_relu_batch2",
        "conv2d_depthwise_bias_gelu",
        "conv2d_depthwise_bias_gelu_batch1",
        "conv2d_depthwise_bias_gelu_batch2",
        "conv2d_depthwise_bias_silu",
        "conv2d_depthwise_bias_silu_batch1",
        "conv2d_depthwise_bias_silu_batch2",
        "conv2d_separable",
        "conv2d_separable_relu",
        "conv2d_separable_gelu",
        "conv2d_separable_silu",
        "conv2d_separable_relu_batch1",
        "conv2d_separable_gelu_batch1",
        "conv2d_separable_batch1",
        "conv2d_separable_batch2",
        "conv2d_separable_bias",
        "conv2d_separable_bias_batch1",
        "conv2d_separable_bias_batch2",
        "conv2d_separable_bias_relu",
        "conv2d_separable_bias_relu_batch1",
        "conv2d_separable_bias_relu_batch2",
        "conv2d_separable_bias_gelu",
        "conv2d_separable_bias_gelu_batch1",
        "conv2d_separable_bias_gelu_batch2",
        "conv2d_separable_bias_silu",
        "conv2d_separable_bias_silu_batch1",
